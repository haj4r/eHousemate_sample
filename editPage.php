...
/* $sqlupdate = "UPDATE housemate_application SET status_id = '".$status_id."' WHERE housemate_id ='".$id."'"; */
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Application Edited Page</h1>
          </div> <!-- /.col -->
        </div> <!-- /.row -->
      </div> <!-- /.container-fluid -->
    </div>
              ...
              <div class="col-md-6">
                ...
                <div class="card card-danger">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                          <label for="exampleInputStudentSemester">Semester</label>
