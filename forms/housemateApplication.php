        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="eHousemate/mainApplicationStatus.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <div class="card card-danger">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputStudentID1" placeholder="Enter Your Student ID">
              </div>
              <div class="col-sm-6">
                <!-- select -->
                <div class="form-group">
...
<!-- ------------------------------ -->
      ...
      <!-- /.row -->
      <button type="button" class="btn btn-block btn-secondary normal">SUBMIT</button>
    </div><!-- /.container-fluid -->
  </section>
  <!-- /.content -->
</div>
