...
if(isset($_POST['Check'])) {
  $sql = "SELECT * FROM housemate_application WHERE stud_id = '".$_SESSION['id']."'";
  $result = mysqli_query($dbconn,$sql);
  $row = mysqli_fetch_assoc($result);
  $status_id = $row['status_id'];
  $id = $row['housemate_id'];
  if($status_id == 'A') {
    header("Location: approvedApplication.php?id=$id");
  } else {
    header("Location: rejectedPage.php");
  }
}
?>
<!DOCTYPE html>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                <table id="vertical-1">
                  <form action="mainApplicationStatus.php" method="post">
                  <div class="btn-group">
                    <button type="submit" name="Check" id="Check" class="btn btn-primary">Check Your Result</button>
                  </div>
                </form>
              </div>
            </div>
